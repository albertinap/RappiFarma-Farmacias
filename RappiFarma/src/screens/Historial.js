  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Visualización de historial de pedidos</Text>
        <Text style={styles.description}>
          Información de los pedidos que se han entregado a clientes 
        </Text>
      </View>      
            ...
            return (
              ...
              >
                ...
                <View style={styles.estadoSection}>
                  <Text style={styles.sectionLabel}>Estado: {offer?.envioState || "Entregado"}</Text>            
                </View>
              </View>
            );
          })
